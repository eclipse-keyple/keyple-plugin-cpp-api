 ...
 *
 * @since 2.0.0
 * @deprecated Use CardRemovalWaiterAsynchronousApi instead (will be removed in a future
 *             version of this API).
 */
...
public:
     ...
     *
     * @since 2.0.0
     * @deprecated Use CardRemovalWaiterAsynchronousApi#onCardRemoved() instead.
     */
