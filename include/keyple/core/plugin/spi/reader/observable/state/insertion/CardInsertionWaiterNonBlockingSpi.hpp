 ...
 * keyple::core::plugin::spi::reader::ReaderSpi#checkCardPresence} method will be called
 * periodically by the service when a card insertion is expected.
 *
 * <p>The value returned by the getCardInsertionMonitoringSleepDuration() will be used as
 * an argument to Thread::sleep(long) between two calls to
