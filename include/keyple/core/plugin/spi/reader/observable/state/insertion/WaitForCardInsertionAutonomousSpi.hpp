 ...
 *
 * @since 2.0.0
 * @deprecated Implement CardInsertionWaiterAsynchronousSpi instead (will be removed in a
...
public:
     ...
     */
    virtual void
    connect(WaitForCardInsertionAutonomousReaderApi* waitForCardInsertionAutonomousReaderApi)
        = 0;
};
