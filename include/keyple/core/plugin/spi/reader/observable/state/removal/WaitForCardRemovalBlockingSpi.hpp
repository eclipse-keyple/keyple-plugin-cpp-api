 ...
 *
 * @since 2.0.0
 * @deprecated Implement CardRemovalWaiterBlockingSpi instead (will be removed in a future
 *             version of this API).
 */
...
public:
     ...
     * example invocation of stopWaitForCardRemoval()), in this case an exception is
     * raised.
     *
